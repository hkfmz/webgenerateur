...
function theheader($titre){
    $header ='
    <!-- Header -->
    <section id="header">

        <!-- Logo -->
            <h1><a href="index.html">'.$titre.'</a></h1>
...
function thefooter(){
    $myfooter='<section id="footer"><div class="container">
    <div class="row">
    <!-- div titre & date -->
            '.thefooter_dates().'
            <div class="col-4 col-12-medium">
